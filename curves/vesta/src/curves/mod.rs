...
use ark_ec::{models::CurveConfig, scalar_mul::glv::GLVConfig, short_weierstrass::{self as sw, SWCurveConfig, SWSerializationXNonZero}, AffineRepr};
...
impl SWSerializationXNonZero for VestaConfig {}

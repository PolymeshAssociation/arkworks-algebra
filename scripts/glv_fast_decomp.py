...
CURVES = {
    ...
    "secp256k1": dict(
        ...
        limbs=4,
        n=[
            (-1, 303414439467246543595250775667605759171),
            (+1, 64502973549206556628585045361533709077),
            (-1, 64502973549206556628585045361533709077),
            (-1, 367917413016453100223835821029139468248),
        ],
    ),
    "secq256k1": dict(
        r=115792089237316195423570985008687907853269984665640564039457584007908834671663,
        lam=60197513588986302554485582024885075108884032450952339817679072026166228089408,
        limbs=4,
        n=[
            (-1, 303414439467246543595250775667605759171),
            (+1, 64502973549206556628585045361533709078),
            (-1, 64502973549206556628585045361533709078),
            (-1, 367917413016453100223835821029139468249),
        ],
    ),
}
